...
<div class="role-form">
    ...
    <?php // $form->field($model, 'updated_at')->textInput() ?>
        ...
        foreach (array_reverse($model->perms) as $perm){?>
        <input type="checkbox" <?= ($children[$perm->name] === $perm->name) ? "checked" : "" ?> name="Perm[<?= $perm->name ?>]" value="<?= $perm->name ?>" /> <b><?= $perm->description ?></b><br/>
        <?php
        }
        ?>
    <br/>
